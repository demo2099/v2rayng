...
class ServerAnytlsActivity : BaseServerActivity() {

    override val serverConfigType: EConfigType = EConfigType.ANYTLS
    ...
    @Composable
    private fun AnytlsProtocolFields(state: ServerUiState) {
        FormTextField(
